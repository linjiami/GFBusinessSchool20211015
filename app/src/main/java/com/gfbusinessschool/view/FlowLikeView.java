...
public class FlowLikeView extends RelativeLayout {
    ...
    private void initParams() {
        ...
        mLayoutParams.addRule(ALIGN_PARENT_RIGHT);
    ...
    private AnimatorSet generateEnterAnimation(View target) {
        ...
        ObjectAnimator scaleX = ObjectAnimator.ofFloat(target, "scaleX", 0.9f, 1f);
    ...
    private ValueAnimator generateCurveAnimation(View target) {
        ...
        ValueAnimator valueAnimator = ValueAnimator.ofObject(evaluator,
                new PointF((float) ((mViewWidth - mPicWidth)), mViewHeight - mChildViewHeight - mPicHeight),
                new PointF((float) ((mViewWidth) + (mRandom.nextBoolean() ? 1 : -1) * mRandom.nextInt(100)), 0));
