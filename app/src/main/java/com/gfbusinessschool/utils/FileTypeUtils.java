...
public class FileTypeUtils {
    ...
    public static final int FILE_TYPE_PDF     = 55;

    //PPT文件
    public static final int FILE_TYPE_PPT     = 61;
    public static final int FILE_TYPE_PPTX     = 62;
    ...
    static {
        ...
        addFileType("DOC", FILE_TYPE_DOC, "DOC");
        addFileType("DOCX", FILE_TYPE_DOCX, "DOCX");
        addFileType("XLS", FILE_TYPE_XLS, "XLS");
        addFileType("XLSX", FILE_TYPE_XLSX, "XLSX");
        addFileType("PDF", FILE_TYPE_PDF, "PDF");

        addFileType("PPT", FILE_TYPE_PPT, "PPT");
        addFileType("PPTX", FILE_TYPE_PPTX, "PPTX");
     ...
     * @return
     */
    public static boolean isWordPDFFileType(String path) {
        MediaFileType type = getFileType(path);
        if(null != type) {
            return isWordPdfFileType(type.fileType);
        }
        return false;
    }
     ...
     * @return
     */
    public static boolean isWordFileType(String path) {
        MediaFileType type = getFileType(path);
        if(null != type) {
    ...
    private static boolean isWordPdfFileType(int fileType){
    ...
    public static boolean isPPTFileType(String path) {
        MediaFileType type = getFileType(path);
        if(null != type) {
            return (type.fileType >= FILE_TYPE_PPT &&
                    type.fileType <= FILE_TYPE_PPTX);
        }
        return false;
    }
}